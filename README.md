...
> [!caution]
> A new direction has been decided for this image. In a bid for higher independence from upstream projects, this will be moving to a bootc base, meaning that everything
